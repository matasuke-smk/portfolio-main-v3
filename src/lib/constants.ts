...
export const WORKS = [
  {
    ...
    description: 'モダンなデザインとスムーズなアニメーションを取り入れたIT企業のコーポレートサイト',
    image: '/images/works/corporate-tech.jpg',
    url: '#',
  },
  {
  ...
  },
  {
    ...
    industry: '高級和食',
    period: '2023年11月 (4週間)',
    technologies: ['Next.js', 'TypeScript', 'GSAP', 'EmailJS'],
    description: '伝統とモダンを融合させた高級和食店のウェブサイト',
    image: '/images/works/restaurant-premium.jpg',
    url: '#',
  },
  {
    id: 'clinic-beauty',
    ...
    description: '清潔感と信頼性を重視した美容皮膚科クリニックのサイト',
    image: '/images/works/clinic-beauty.jpg',
    url: '#',
  },
];
